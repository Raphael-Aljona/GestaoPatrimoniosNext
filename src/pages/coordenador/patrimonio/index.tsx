...
import {importarPatrimonio} from "@/src/pages/api/patrimonioService";
...
const Patrimonio = () => {
    ...
    async function cadastrarArquivo(e: React.FormEvent<HTMLFormElement>) {
        ...
        try{
            await importarPatrimonio(arquivo)
            ...
            <main className={styles.page_content}>
                ...
                <section className={`${styles.table_section} layout_guide`} aria-label="Lista de ambientes">
                    <form className={styles.search_area} role="search">
                        <label htmlFor={styles.pesquisa_ambiente} className={styles.sr_only}>Pesquise o
                            patrimônio</label>

                        <input type="search" id="pesquisa_ambiente" name="pesquisaAmbiente"
